...
for(var i=0; i<3; i++) {
    ...
    for(var j=0; j<json.features[i].geometry.coordinates[0][0].length; j++) {
        var floatarr = [];
        //console.log(Number.parseFloat(json.features[i].geometry.coordinates[0][0][j][0]).toFixed(16))
        //console.log(Number.parseFloat(json.features[i].geometry.coordinates[0][0][j][1]).toFixed(16))
        floatarr.push(Number.parseFloat(Number.parseFloat((json.features[i].geometry.coordinates[0][0][j][0]).toFixed(16))));
        floatarr.push(Number.parseFloat(json.features[i].geometry.coordinates[0][0][j][1]));
